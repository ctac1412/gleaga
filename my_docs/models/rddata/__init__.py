...
city = (u'Москва',u'Санкт-Петербург',u'Казань',u'Барнаул',u'Сызрань',u'Абдулино',u'Железногорск')
country = (u'Россия',u'Казань')
street = (u'Лесная',u'Кирпичная',u'Дальняя',u'Земляничная',u'Тимирязева',u'Полевая',u'Солнечная')
