...
class dop_dogovor(models.Model):
    _name = 'tech_directory.dop_dogovor'
    _rec_name = 'date'
    date = fields.Date(fields.Date.context_today)

    doc_package_id = fields.Many2one(
        comodel_name="tech_directory.doc_package",
        domain=[('type_komplekt', '=', 'dop_soglashenoie')],
    ...
    dop_prosrochka_int = fields.Selection([ ('d1', '1'),
                                            ...
                                            ('d29', '29'),
                                            ('d30', '30')],default='d5')
    max_summ_zadolghosti_int = fields.Integer(default= '20000')
    kolv_vo_doc_free_int = fields.Integer(default= '5')
    summ_avance_int = fields.Integer(default= '3')
    ...
    dogovor_id = fields.Many2one('tech_directory.dogovor')
